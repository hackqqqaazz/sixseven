...
v225:AddParagraph({
    ["Title"] = "Script made by Hoang Ha Duong",
    ["Content"] = "Thank for use script"
})
v225:AddButton({
    ["Title"] = "Script create by H.Thành",
    ["Description"] = "Click to Copy",
    ["Callback"] = function()
        setclipboard("Script create by h.thànhdz")
    end
})
v225:AddButton({
    ["Title"] = "mukbang duamuoi",
    ["Description"] = "Click to Copy",
    ["Callback"] = function()
        setclipboard("CaiJcolaiduamuoiaf?")
    end
})
local v226 = {
    ["Main"] = v224:AddTab({
...
v227["2"].Image = "rbxassetid://92239672811324"
